...
if __name__ == "__main__":
    ...
    ap.add_argument("-c", "--cfg", type=str, default="yolov3.cfg",
                    help="Ingrese el archivo de configuracion")
    ap.add_argument("-y", "--weights", type=str, default="yolov3.weights",
                    help="ingrese los pesos del yolo")
    ap.add_argument("-i", "--img", type=str, default="parking.jpg",
                    help="ingrese la imagen a procesar")
    ap.add_argument("-o", "--salida", type=str, default="salida-yolo.jpg",
